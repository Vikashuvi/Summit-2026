            ...
            <nav aria-label="Primary" className="hidden md:block">
              <ul className="flex items-center gap-6 m-0 p-0">
                ...
                <li>
                  <a
                    href="#tickets"
                    className="inline-flex items-center rounded-sm border-2 border-black px-3 py-1 text-[12px] no-underline text-black hover:bg-black hover:text-white transition-colors"
                    onClick={(e) => {
                      e.preventDefault()
