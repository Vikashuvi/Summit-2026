      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-12 items-stretch">
        ...
        <div className="md:col-span-5 h-full">
          <div className="rounded-md border-2 border-black bg-white p-6 md:p-8 h-full flex flex-col">
            ...
            <ul className="mt-4 space-y-3 text-[clamp(1rem,1.5vw,1.15rem)] leading-relaxed text-neutral-800">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {[
              ...
              >
                ...
                <p className="mt-3 text-[1.05rem] leading-relaxed transition-colors duration-300 group-hover:text-white">{it.text}</p>
